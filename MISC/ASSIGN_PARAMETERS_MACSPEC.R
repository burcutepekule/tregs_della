...
if(control==1){
  ...
  activity_ROS_M1 = param_set_use$activity_ROS_M1
}
...
activity_engulf_M0 = param_set_use$activity_engulf_M0
activity_engulf_M1 = param_set_use$activity_engulf_M1
activity_engulf_M2 = param_set_use$activity_engulf_M2
